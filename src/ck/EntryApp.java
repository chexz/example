...
public class EntryApp implements UncaughtExceptionHandler {
	...
	public void printUsage() {
		System.out.println("Usage : java -jar ElementClassify.jar [--element-table elementTable.xls] [--result result.xls] source01.xls source02.xls ...");
		System.exit(-255);
	}
	...
	public static void main(String args[]) {
		...
		Workbook elementBook = null;
		try {
			elementBook = Workbook.getWorkbook(new File(app.getElementTableFilename()));
		} catch (Exception e) {
			e.printStackTrace();
		}
